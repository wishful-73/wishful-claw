...
public static class EntityMappers
{
    ...
    public static SessionEntity MapSession(SqliteDataReader r) => new()
    {
        ...
        ContextCapTokens = r.GetNullableInt32("context_cap_tokens") ?? 0,
        ContextCapModelId = r.GetNullableString("context_cap_model_id"),
        CompressionThreshold = r.GetNullableDouble("compression_threshold") ?? 0,
        CreatedAt = r.GetInt64("created_at"),
        UpdatedAt = r.GetInt64("updated_at"),
