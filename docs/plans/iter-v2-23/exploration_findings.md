...
>
> 路线更新（2026-08-28）：本报告中原先与当前迭代绑定的正式版发布判断已失效；v2-iter-23 只做可靠性与缺陷收口，后续按 v2-iter-24 功能补齐、v2-iter-25 Release Candidate 准备、v2-iter-26 正式发布推进。
...
5. 正式版发布会改变当前项目 `0.2.N` 版本规则；该风险和文档/Release 流程迁移已移交 v2-iter-26，不在当前迭代执行。
