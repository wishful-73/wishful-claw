...
const EXT_ICONS: Record<string, React.ReactNode> = {
  ...
  '.markdown': <FileText className="size-3.5 text-muted-foreground" />,
  '.txt': <FileText className="size-3.5 text-muted-foreground" />,
  '.log': <FileText className="size-3.5 text-muted-foreground" />,
  '.rst': <FileText className="size-3.5 text-muted-foreground" />,
  '.adoc': <FileText className="size-3.5 text-muted-foreground" />,
...
const NAME_ICONS: Record<string, React.ReactNode> = {
  'readme.md': <FileText className="size-3.5 text-muted-foreground" />,
  'readme': <FileText className="size-3.5 text-muted-foreground" />,
  'license': <FileLock className="size-3.5 text-muted-foreground" />,
  'changelog.md': <FileText className="size-3.5 text-muted-foreground" />,
  ...
  'package-lock.json': <FileLock className="size-3.5 text-muted-foreground" />,
